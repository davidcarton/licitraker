    ...
    >
      <div
        style={{
          ...
          color: "var(--n300)",
          fontFamily:
            "var(--font-body)" /* Fuerza DM Sans en etiquetas secundarias */,
        }}
      >
    ...
    <AnimatePresence>
      ...
      <motion.div
        ...
        style={{
          ...
          overflow: "hidden",
          fontFamily:
            "var(--font-body)" /* Asegura DM Sans de base en el panel */,
        }}
      >
        {/* Franja superior */}
        <div
          style={{ height: 6, background: franjaColor[tipo], flexShrink: 0 }}
        />
        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "var(--n100)";
                e.currentTarget.style.color = "var(--n900)";
              }}
              onMouseLeave={(e) => {
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
            <Campo
              icon={<MapPin size={11} />}
              label="Municipio"
              value={l.municipio || "No especificado"}
            />
            <Campo
              icon={<MapPin size={11} />}
              label="Provincia"
              value={l.provincia || "España"}
            />
            <Campo
            ...
            <Campo
              icon={<Calendar size={11} />}
              label="Publicado"
              value={formatFecha(l.fechaPublicacion)}
            />
          </div>
